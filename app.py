...
def remove_pattern(input_txt,pattern):
    '''
    remove pattern from input_txt using_regex
    '''
...
def predict():
    if request.method == 'POST':
        ...
        stem_tokenized_clean_test = [StemmerI.stem(i) for i in tokenized_clean_test]
...
if __name__ == '__main__':
    ...
    with open('model/logisitic_clf.pkl','rb') as f:
